...
<body>
	...
	<!--  
	사용하는 OS(운영체제)에 따라 경로를 표시하는 방법이 다르므로, application
	내장객체를 통해 절대(물리적)경로를 얻어올 수 있다. 이렇게 얻어온 경로를
	통해 파일업로드를 구현할 수 있다.
	-->
	...
	.metadata 디렉토리 하위에 프로젝트와 동일한 Tomcat 환경을
	만들어서 복사본 파일을 실행하게된다. 따라서 위에서의 물리적 경로는
	.metadata하위의 경로가 출력된다. 
	 -->
